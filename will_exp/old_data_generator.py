...
input_ids=prompt_and_generated_ids.unsqueeze(0)).logits
    ...
    def obtain_api_response(
        ...
        for position in positions:
            text_ids = torch.cat([generated_ids[:position].cpu(), self.api_start_token_id], dim=0)
    ...
    def _generate_conditioning_prompts(
        ...
        for text_ids in candidate_ids:
            ...
            print (self.tokenizer.decode(conditioning_api_ids[0][0])) 
    ...
    def filter_api( 
        ...
        print (self.tokenizer.decode(candidate_ids[0]))
        print (self.tokenizer.decode(conditioning_api_ids[0][0]))
        ...
        print (self.tokenizer.decode(conditioning_text_ids[0][0]))
    ...
    def generate(
        ...
        for api in self.apis:
            ...
            print ("c")
            print(self.tokenizer.decode(text_ids))
            ...
            print(self.tokenizer.decode(filtered_candidate_ids[0]))
